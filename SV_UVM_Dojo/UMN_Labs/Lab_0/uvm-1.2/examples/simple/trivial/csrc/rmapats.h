...
struct iptmpl {
    QIRD  * I596;
    struct vcs_globals_t * I597;
    void * I599;
    UP  I600;
    UP  I601;
    struct iptmpl * I594[2];
};
typedef unsigned long long FileOffset;
typedef struct _hsimPeriodL {
    char  I735[256];
    struct _hsimPeriodL * I707;
} HsimPeriodL;
typedef struct {
    U   I737[2];
    U  I738 :1;
...
typedef struct TableAssign_ {
    struct TableAssign_ * I707;
    struct TableAssign_ * I650;
    U  I5;
    U  iinput;
    RP  ptable;
    RP  I794;
...
struct dummyq_struct {
    ...
    struct futq * I852;
    struct futq * I853;
    struct sched_table * I854;
    struct millenium * I856;
    EBLK  * I858;
    EBLK  * I859;
    EBLK  * I860;
    EBLK  * I861;
